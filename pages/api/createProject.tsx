...
export default async function createProject(req, res) {
    if (req.body.token == AUTH_TOKEN) {
        try {
            let project = {title:req.body.title, description:req.body.description, thumbnail_url:req.body.thumbnail_url, github_url:req.body.github_url, itchio_url:req.body.itchio_url}
