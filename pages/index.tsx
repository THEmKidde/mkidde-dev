        ...
        <>
            ...
            <div className="bg-slate-50 h-full min-h-screen">
                <Container className="pt-40 md:pt-44 lg:pt-52">
                    ...
                    <div className="mt-24">
                        <h3 className="text-2xl font-medium text-center lg:text-left"><a href="/about" className="hover:text-cyan-500 duration-100">About me</a></h3>
                    ...
                    <div className="mt-24">
                        <h3 className="text-2xl font-medium text-center lg:text-left"><a href="/projects" className="hover:text-cyan-500 duration-100">My projects</a></h3>
                        <p className="text-lg text-center lg:text-left">
                    ...
                    <div className="mt-16 mb-8">
                        <h3 className="text-2xl font-medium text-center lg:text-left"><a href="/contact" className="hover:text-cyan-500 duration-100">Get in touch</a></h3>
                        <p className="text-lg text-center lg:text-left">
